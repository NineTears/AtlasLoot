AtlasLoot_Data["AtlasLootSetItems"] = {
	...
	Artifacts = {
		{ 0, "", "", "" },
		{ 12947, "INV_Gizmo_BronzeFramework_01", "=q19=亚历克斯的勇气戒指", "=ds=#s13#" },
	...
	Legendaries = {
		...
		{ 18563, "Spell_Ice_Lament", "=q5=B逐风者禁锢之颅", "=ds=#m10# =q1=#m3#", " 3.78%" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 17782, "INV_Jewelry_Amulet_04", "=q5=束缚坠饰", "=ds=#s2#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 23051, "INV_Spear_05", "=q5=防御者之刃", "=ds=#h3#, #w10# =q17=#c9#" },
	...
	UnobMounts = {
		...
		{ 12325, "Ability_Mount_Jungletiger", "=q3=原始猎豹缰绳", "=ds=#e7#" },
		{ 12326, "Ability_Mount_Jungletiger", "=q3=茶色刃齿豹缰绳", "=ds=#e7#" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		{ 0, "", "", "" },
		...
		{ 0, "", "", "" },
		{ 13318, "Ability_Mount_Raptor", "=q4=奢侈的迅猛龙之哨", "=ds=#e7#" },
		{ 0, "", "", "" },
	...
	RarePets1 = {
		...
		{ 0,"","","" },
		{ 13584, "INV_DiabloStone", "=q3=破坏神之石", "=ds=#e15# =q6=珍藏版" },
		{ 13583, "INV_Belt_05", "=q3=熊猫项圈", "=ds=#e15# =q6=珍藏版" },
		{ 13582, "Spell_Shadow_SummonFelHunter", "=q3=跳虫绳索", "=ds=#e15# =q6=珍藏版" },
		{ 20371, "INV_Egg_03", "=q3=蓝色鱼人卵", "=ds=#e15# =q6=暴雪嘉年华2005" },
		{ 22114, "INV_Egg_03", "=q3=粉色鱼人卵", "=ds=#e15# =q6=暴雪嘉年华2006" },
		{ 0,"","","" },
		{ 23007,"INV_Belt_25","=q1=小猪项圈","=ds=#e15# =q6=儿童周" },
		{ 23015,"INV_Box_PetCarrier_01","=q1=老鼠笼","=ds=#e15# =q6=儿童周" },
		{ 23002,"INV_Crate_03","=q1=乌龟盒","=ds=#e15# =q6=儿童周" },
		{ 21301, "INV_Holiday_Christmas_Present_03", "=q1=绿色助手盒", "=ds=#e15# =q6=冬幕节" },
		{ 21308, "INV_Misc_Bell_01", "=q1=圣诞铃铛", "=ds=#e15# =q6=冬幕节" },
		{ 0,"","","" },
		{ 21305, "INV_Holiday_Christmas_Present_01", "=q1=红色助手盒", "=ds=#e15# =q6=冬幕节" },
		{ 21309, "INV_Misc_Bag_17", "=q1=雪孩子工具包", "=ds=#e15# =q6=冬幕节" },
		{ 22235, "INV_Ammo_Arrow_02", "=q1=真银箭头", "=ds=#e15# =q6=情人节" },
		{ 23083, "INV_Potion_33", "=q1=被捕获的火焰", "=ds=#e15# =q6=仲夏火焰节" },
